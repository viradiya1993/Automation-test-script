    ...
    agents: [
        {
            ...
            link: "https://s3.us-east-2.amazonaws.com/standalones.automationhq.ai/ui/prod/AHQ+Agent+Setup+1.0.1.exe"
        },
        {
            id: "mac",
            icon: "mac-logo",
            name: "Download Agent for MacOS",
            link: "https://s3.us-east-2.amazonaws.com/standalones.automationhq.ai/ui/prod/AHQ+Agent-1.0.1.dmg",
        },
        {
            id: "linux",
            icon: "linux-logo",
            name: "Download Agent for Linux",
            link: "https://s3.us-east-2.amazonaws.com/standalones.automationhq.ai/ui/prod/AHQ+Agent-1.0.1.AppImage",
        },
    ],
